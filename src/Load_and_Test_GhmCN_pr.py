...
if regression_flag == 0:
    ...
    print('Test   PCC:', round(test_pearson,4))
...
f.write('        Performance:\n')
if regression_flag == 0:
    f.write('           Test AUROC: ' + str(round(test_AUROC,4)) + '\n')
    f.write('           Test  AUPR: ' + str(round(test_AUPR,4))  + '\n')
    f.write('           Test    F1: ' + str(round(test_F1,4))    + '\n')
elif regression_flag == 1:
    f.write('           Test   PCC: ' + str(round(test_pearson,4)) + '\n\n')
f.close()
