...
if save_model:
    model_path = os.path.join(save_dir, 'GhmCN_model_' + date_and_time + '.pt')
    torch.save(model.state_dict(), model_path)
    df_full_metrics_filename = os.path.join(save_dir, 'GhmCN_model_predictions_' + date_and_time + '.csv')
    df_full_metrics.to_csv(df_full_metrics_filename, index=False)

model_info_filename = os.path.join(save_dir,'GhmCN_model_' + date_and_time + '_info.txt')
