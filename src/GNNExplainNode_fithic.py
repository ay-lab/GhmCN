...
from torch_geometric.explain import ExplainerConfig, Explainer, GNNExplainer
...
# >>> Load input files
base_path               = os.path.join(os.path.dirname(__file__), data_folder,cell_line)
...
# Attempt at new GNNExplainer version, failed, using deprecated version
print('about to GNN exp', flush=True)
explainer = Explainer(
    model=model,
