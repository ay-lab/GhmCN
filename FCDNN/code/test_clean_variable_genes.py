...
out_path='/mnt/BioAdHoc/Groups/RaoLab/Edahi/Projects/09.TimeCourse5hmC/ForFerhatGit/FCDNN/results/fcdnn_most_variable_genes/'
...
metrics_file_name = 'metrics_CleanSamples_tested_on_MostVariableGenes.csv'
predictions_file_name = 'predictions_CleanSamples_tested_on_MostVariableGenes.csv'
output_file_roc = os.path.join(out_path,'roc_curve_CleanSamples_tested_on_MostVariableGenes.png')
