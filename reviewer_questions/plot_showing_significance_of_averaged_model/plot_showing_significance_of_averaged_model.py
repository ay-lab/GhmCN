# Sconda conda activate ghmc1; cd /mnt/BioAdHoc/Groups/RaoLab/Edahi/Projects/09.TimeCourse5hmC/ForFerhatGit/GhmCN/reviewer_questions/plot_showing_significance_of_averaged_model; python
import pandas as pd
...
n_val_per_cell = df_melted_mix.shape[0]//len(cells)
